...
// template <class T>
// bool ImageIO::from_numpy(const char *filename, T *&pImagePlane, int &width, int &height, int &nchannels)

// template <class T>
// bool ImageIO::to_numpy(const char *filename, T *&pImagePlane, int &width, int &height, int &nchannels)
